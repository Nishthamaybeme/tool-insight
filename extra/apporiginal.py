...
# print(generate_detailed_description(image_path="path/to/hammer.jpg", object_name="Knife"))  # Conflict Case
# print(generate_detailed_description(object_name="Knife"))  # Name Only
# print(generate_detailed_description(description="A sharp object used for cutting."))  # Description Only
# print(generate_detailed_description(image_path="61HR6kgbCLL.jpg"))  # 
